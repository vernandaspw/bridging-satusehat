                    ...
                    <div class="card-body">
                        <form id="filterForm" action="" method="get">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="tanggal">Tanggal <small>(kosongkan tanggal saat
                                                ini)</small></label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control selectric" id="status_rawat" name="status_rawat">
                                            <option value="" selected disabled>-- Silahkan pilih --</option>
                                            <option value="RAWAT JALAN" {{ request('status_rawat') ? 'selected' : '' }}>
                                                Rawat Jalan</option>
                                ...
                                <div class="col-md-3 filter-buttons">
                                    <div class="form-group d-flex align-items-end">
                                        <button type="submit" class="btn btn-primary mr-2" style="margin-top: 30px;"><i
                                                class="fas fa-filter"></i> Filter</button>
                                        <button type="button" class="btn btn-danger" style="margin-top: 30px;"
                                            onclick="resetForm()"><i class="fas fa-sync"></i> Reset</button>
                                    </div>
                                </div>
                            </div>
                        </form>
